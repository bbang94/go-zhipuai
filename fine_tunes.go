...
// Deprecated: On August 22nd, 2023, zhipuai announced the deprecation of the /v1/fine-tunes API.
// This API will be officially deprecated on January 4th, 2024.
// zhipuai recommends to migrate to the new fine tuning API implemented in fine_tuning_job.go.
