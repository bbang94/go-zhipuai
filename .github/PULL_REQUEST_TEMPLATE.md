...
Please search among the [Pull request](https://github.com/bbang94/go-zhipuai/pulls) before creating one.
...
**Provide zhipuai documentation link**
Provide a relevant API doc from https://platform.zhipuai.com/docs/api-reference
